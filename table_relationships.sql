...
INSERT INTO `blog_post` VALUES ('honesty is always the best option to choose','honesty is the best policy','2021-05-06',1,1),('tiger is an extinct animal','extinct species','2022-01-03',2,3),('climate changing is affecting us ','climate change','2021-05-08',1,4),('bigger cities have more traffic','increasing traffic','2022-01-06',2,5);
...
INSERT INTO `blog_post_comment` VALUES ('you are sure about honesty','2021-05-07',1,1,1),('yes!! tigers are!!','2022-01-03',2,3,2),('yes honestly always is','2021-05-06',1,1,3),('true!!!','2021-05-07',1,1,4),('well!! we are creating pollution','2021-05-08',1,4,6),('yes climate change is real','2021-05-09',1,4,7),('carbon emissions are on the rise','2021-05-10',1,4,8),('tigers are deceasing day by day','2022-01-05',2,3,9),('we should stop hunting tigers','2022-01-07',2,3,10),('traffic is a real problem','2022-01-06',2,5,11),('traffic kills many people','2022-01-09',2,5,12),('traffic makes us late everytime','2022-01-11',2,5,13),('root cause delete me of accidents','2022-01-04',2,5,16);
...
INSERT INTO `blogger` VALUES ('username_one','123456','user_one','2018-01-03','user_one@email.com',1),('username_two','123456','user_two','2020-01-01','user_two@email.com',2),('username_three','pass','user_three','2021-04-06','user_three@email.com',3);
...
-- Dump completed on 2022-09-14 12:43:34
